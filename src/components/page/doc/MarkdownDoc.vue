  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-tickets"></i> 使用文档
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-row class="tac">
      <el-col :span="6">
        <div name="side_menu">
          <el-menu default-active="0">
            <div v-for="m in menuTree" v-bind:key="m.index">
              <el-menu-item
                :index="m.index.toString()"
                v-if="!m.showChild"
                @click="loadMarkdown(m.index)"
              >
...
<script>
var htmlMDD = require("@/components/page/doc/md_docs/00 CHANGELOG.md");
...
export default {
  ...
  methods: {
    loadMarkdown(index) {
      this.htmlMD = this.htmlMDList[index];
    },
    getMenuTree() {
      const filesMD = require.context(
        "@/components/page/doc/md_docs",
        true,
        /\.md$/
      );
      this.htmlMDList = requireAll(filesMD);
